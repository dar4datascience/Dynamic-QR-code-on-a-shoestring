...
<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 70vh; text-align: center; padding: 2rem;">
  <h1 style="margin-bottom: 2rem;">🎉 Special Offer</h1>
  
  <p style="font-size: 1.2rem; margin-bottom: 2rem;">Click the button below to view our current promotion.</p>
...
1. Edit this file: `promo.qmd`
2. Find the line: `<a href="https://example.com/special-offer"`
